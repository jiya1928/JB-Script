...
class Interpreter:
    ...
    def register_builtins(self):
        self.global_environment.define("say", self.builtin_say)
        self.global_environment.define("len", self.builtin_len)
        self.global_environment.define("type", self.builtin_type)
        self.global_environment.define("str", self.builtin_str)
        self.global_environment.define("number", self.builtin_number)
        self.global_environment.define("keys", self.builtin_keys)
        self.global_environment.define("values", self.builtin_values)
        self.global_environment.define("range", self.builtin_range)
    ...
    def builtin_len(self, value):
        ...
        raise Exception("len() expects a string, array, or object")
    ...
    def builtin_keys(self, value):
        if not isinstance(value, dict):
            raise Exception("keys() expects an object")

        return list(value.keys())

    def builtin_values(self, value):
        if not isinstance(value, dict):
            raise Exception("values() expects an object")
    ...
    def get_property(self, obj, name):
        ...
        # request.query.name
        #
        # when request.query is a Python/JB dictionary.
        ...
        if isinstance(obj, list):
            ...
            if name == "unshift":
                return lambda value: obj.insert(0, value)
    ...
    def call_function(self, function, arguments):
        ...
        if isinstance(function, JBFunction):
